...
Приветы. Первый раз что-то выкладываю на GitHub, не бейте тапками. Здесь я собрал список доменов для обхода блокировок через [NetFix](https://github.com/rupleide/NetFix).
