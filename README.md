...
Приветы. Первый раз что-то выкладываю на GitHub, не бейте тапками. Здесь я собрал списки доменов для обхода блокировок через [NetFix](https://github.com/rupleide/NetFix).
...
*   `OG Zapret... .netfix-mod` — Это оригинальные списки из [Zapret от Flowseal](https://github.com/Flowseal/zapret-discord-youtube). (Актуальные для 1.10.2)
